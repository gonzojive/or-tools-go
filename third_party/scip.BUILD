...
# https://github.com/google/or-tools/blob/stable/bazel/scip.BUILD and is subject
# to the license Apache 2.0 license.
...
PLATFORM_DEPS = select({
    "on_linux": ["@bliss//:libbliss", "@zlib//:zlib"],
    "on_macos": ["@bliss//:libbliss", "@zlib//:zlib"],
